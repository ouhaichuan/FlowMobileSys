...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, OnItemClickListener listener) {
		this(context, listener, LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
	}

	public TitlePopup(Context context, OnItemClickListener listener, int width,
			int height) {
		super(context);
